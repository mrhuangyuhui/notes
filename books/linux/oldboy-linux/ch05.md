...
配置文件 [`www.conf`](/books/linux/oldboy-linux/codes/ch05/5.5.2/www/www.conf)
...
部署脚本 [`docker-compose.yml`](/books/linux/oldboy-linux/codes/ch05/5.5.2/www/docker-compose.yml)
...
services:
  web:
    ...
    volumes:
      ...
      - ./index.html:/usr/share/nginx/html/www/index.html
    ports:
      - "80:80"
```
